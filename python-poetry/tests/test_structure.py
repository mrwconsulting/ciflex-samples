...
isort_config = isort.Config(line_length=120, known_first_party=["app"])
...
def test_pep8():
    ...
    check_directory_style(os.path.join(REPO_ROOT, "app"), errors)
...
def test_import_order():
    ...
    check_directory_imports(os.path.join(REPO_ROOT, "app"), import_diffs)
